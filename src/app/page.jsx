...
export const metadata = {
  title:
    "Qbits Inverters - Leading Solar EPC Company in Gujarat | Qbits Inverters",
  description:
    "Qbits Inverters Limited - Gujarat's top 3 EPC firm with 10,000+ solar installations. Makers of Qbits intelligent on-grid solar inverters. ISO 9001 certified, official Adani Solar distributor.",
  keywords:
    "solar energy, EPC company Gujarat, solar installation, Qbits inverters, Qbits Inverters, solar panels, renewable energy, Surat solar company",
...
const highlights = [
  {
    icon: "/images/container/icon-1.svg",
    title: "Smart Conversion, Every Second",
    description: "Real-time DC to AC efficiency with AI-backed processing.",
  },
  {
    icon: "/images/container/icon-2.svg",
    title: "Higher Output, Lower Losses",
    description: "Built with N-Type Mono for up to 50% more energy yield.",
  },
  {
    icon: "/images/container/icon-3.svg",
    title: "On-Time, Every Time",
    description: "Fast-track in-house manufacturing & delivery process.",
  },
  {
    icon: "/images/container/icon-4.svg",
    title: "Solar Material Financing Support",
    description: "Helping you go solar without the upfront financial burden.",
  },
  {
    icon: "/images/container/icon-5.svg",
    title: "Reliable. Durable. Always On",
    description: "Performance that lasts — from rooftop to grid.",
  },
];
    ...
    <>
          ...
          <div className="flex md:flex-row flex-col-reverse gap-8 md:gap- w-full">
            ...
            <div className="md:w-full w-full ">
              ...
              <p className="text-[#606062] font-medium">
                ...
                Gujarat’s top 3 EPC firms by 2024. Headquartered in Surat with
                offices in Ahmedabad and Junagadh, the company has successfully
                completed 10,000+ solar installations across 20+ cities, built a
                team of 70+ experts, and established trusted partnerships with
                DISCOM, GEDA, SLDC, and GUVNL.
              </p>
              <br />
              <p className="text-[#606062] font-medium">
                ...
                ₹0 to crossing ₹100+ Cr in 2024, the Heaven Green Energy journey
                is a story of innovation, resilience, and a relentless
                commitment to building a cleaner, greener India.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                ...
                <div className="flex items-center justify-center">
                  <img src="images/story2.png" alt="Story 2" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-cover bg-center">
        <div className="mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16 lg:gap-0 mt-20">
            {highlights.map((item, index) => (
              <div key={index} className="relative w-fit mx-auto">
                {/* Round background */}
                <img
                  className="absolute top-[-20%] left-1/2 -translate-x-1/2"
                  src="/images/container/round-bg.png"
                  alt="round background"
                />

                {/* Icon centered inside the round background */}
                <div
                  className=" absolute left-1/2 -translate-x-1/2 top-[-20%] flex items-center justify-center w-[112px] h-[112px] pr-[5px]"
                >
                  {/* If item.icon is a React component/node */}
                  <div>
                ...
                {/* Container background with content */}
                <div className="relative">
                  <img
                    className="mx-auto block"
                    src="/images/container/container-bg.png"
                    alt="container"
                  />

                  {/* Text content positioned within the container */}
                  <div
                    className="absolute inset-x-0 flex flex-col items-center text-center px-6 sm:px-8 md:gap-2"
                    style={{
                      /* Adjust vertical placement inside the container */
                      top: "33%", // positions content below the notch area
                    }}
                  >
                    <h3 className="text-[#16A16C] text-base sm:text-lg font-semibold leading-snug">
                      {item.title}
                    </h3>
                    <p className="text-[#606062] text-xs sm:text-sm mt-2 max-w-[240px]">
                      {item.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:w-[60%] w-full py-5 px-3">
            <div className="space-y-16">
              ...
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-6 text-center md:text-start">
                with Built-In Memory for Uninterrupted Monitoring.
              </h2>
              <p className="text-white text-lg md:text-xl text-center md:text-start">
                Shaping the Future of Solar with Intelligent & Reliable
                Inverters / Transforming Energy with <br /> Intelligent,
                Real-Time Solar Solutions
              </p>
              <div className="text-[14px] md:text-lg">
                <span className="flex items-center gap-2 mt-6 text-white">
                  <CheckBox />{" "}
                  <p className="">
                    India’s first inverter with local storage backup
                  </p>
                </span>
                <span className="flex items-center gap-2 mt-6 text-white">
                  <CheckBox />{" "}
                  <p>No data loss during power or internet failure</p>
                </span>
                <span className="flex items-center gap-2 mt-6 text-white">
                  <CheckBox />{" "}
                  <p>
                ...
                <span className="flex items-center gap-2 mt-6 text-white">
                  <CheckBox />{" "}
                  <p>24×7 remote support + real-time AI monitoring</p>
                </span>
                <span className="flex items-center gap-2 mt-6 text-white">
                  <CheckBox />{" "}
                  <p>Built-in for EPCs, businesses, and smart homes</p>
                </span>
              </div>
            </div>
          </div>
