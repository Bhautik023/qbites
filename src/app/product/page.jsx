...
export const metadata = {
  title:
    "Qbits Solar Inverters - Single & Three Phase Grid Tie Inverters | Qbits Inverters",
  description:
...
const Product = () => {
  const products = [
    ...
    // 11 New Products from PDF (IDs 4 - 14)
    {
      ...
      image: "/images/products/3.6K Front View.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/5KTLD.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/6KTLD.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/8KTLC.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/12KTLC.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/15KTLC.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/20KTLC.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/30KTLC.png",
      icon1: "/images/products/chip-icon.svg",
      icon2: "/images/products/ip-icon.svg",
      icon3: "/images/products/design-icon.svg",
      features: [
