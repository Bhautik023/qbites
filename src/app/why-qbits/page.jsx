            ...
            <div className="bg-white rounded-full p-3 lg:p-4 flex items-start gap-4 lg:gap-6 max-w-4xl mr-auto">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm md:text-md lg:text-lg leading-relaxed">
                  ...
                  —a trusted name with{" "}
                  <span className="text-orange-500 text-sm md:text-md lg:text-lg font-semibold">10,000+</span>{" "}
                  installations –{" "}
                  <span className="text-orange-500 text-sm md:text-md lg:text-lg font-semibold">Qbits</span>{" "}
          ...
          <div className="hidden md:grid grid-cols-2 gap-10">
            ...
            <div className="flex items-center h-full px-12">
              <div className="flex items-start gap-4">
                <div className="text-orange-500 text-2xl font-bold mt-1">▶</div>
                <div>
